    ...
    def make_email(self):
        ...
        if self.reminder == 'reminder_days':
            reminder = """\
                ...
                <i>I will send one more reminder, and after 4 days since you completed the last survey, the link for this survey will close so that we can keep the course timings similar across participants.</i>
                </p><br/>
                """
        elif self.reminder == 'reminder_days_final':
            reminder = """\
                <p><i>This is a friendly reminder about your mindfulness practice. If you do not complete the session today, we will email you tomorrow asking you to complete the main post-course survey.
                </i></p><br>
                """
        elif self.reminder == 'reminder_post':
            reminder = """\
                <p><i>This is a friendly reminder about the final survey.<br>
                I will send one more reminder, and after this the survey link will close so that we can keep the course timings similar across participants.</i>
                </p><br>
                """
        elif self.reminder == 'reminder_post_final':
            reminder = """\
                <p><i>This is a friendly reminder about the final survey.<br>
                I will not send another reminder, and after tomorrow the survey link will close so that we can keep the course timings similar across participants.
                </i></p><br>
                """
        ...
        if self.body == 'day_1':
            ...
            body = f"""\
                ...
                <p>If you wish to not receive this next email or have any further questions, please email me at m.lovell@sussex.ac.uk</p><br/><br/>
    ...
    def make_plaintext(self):
        if self.reminder == 'reminder_days':
            reminder = """\
                ...
                I will send one more reminder, and after 4 days since your last practice the survey link will close so that we can keep the course timings similar across participants.
                """
        elif self.reminder == 'reminder_days_final':
            reminder = """\
                This is a friendly reminder about your mindfulness practice.
                I will not send another reminder, and after 4 days since your last practice the survey link will close so that we can keep the course timings similar across participants.
                """
        elif self.reminder == 'reminder_post':
            reminder = """\
        ...
        if self.body == 'day_1':
            ...
            body = f"""\
                ...
                We'll send you a reminder email if you don't manage to complete the survey today. 
                Note that after 3 reminders we will assume you have dropped out of the study, and will invite you to take the second survey. 
                You are welcome to repeat today’s practice as many times as you want, but don’t attempt to go beyond it until tomorrow's session. 
                I will send tomorrow's practice automatically the day after you complete the session linked above.
            ...
            body = f"""\
                ...
                If you wish to not receive this next email or have any further questions, please email me at m.lovell@sussex.ac.uk
