    ...
    def make_email(self):
        ...
        if self.body == 'day_1':
            ...
            body = f"""\
                ...
                The Mindfulness research group</p>
                """
        # Usually if the folder doesn't update properly and the wrong emails are sent out, can add this above the reminder:
            # <p>Appologies if you recieved the wrong email this morning!<br>
            # There was an issue updating the log of finished surveys so I'm sending them out again with the updated files.<br>
            # You can disregard the previous email if you were incorrectly informed you had missed too many days. Thanks!<p>
        return  f"""\
            <html>
              <body>
                {reminder}
